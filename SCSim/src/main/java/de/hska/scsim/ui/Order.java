...
public class Order extends JPanel {
    ...
    public void setData(List<PurchasePlanningResult> data) {
        ...
        String[] StringsWith = {
            Messages.getString("order.standard"), Messages.getString("order.fast"), "-"};
...
//				});
    ...
    public Integer summeBerechnen() {
        ...
        for (int i = 0; i < data.size(); ++i) {
            ...
            //box.getItemAt(box.getSelectedIndex()) != null
            if (box.getSelectedItem() != null) {
                ...
                } else if (box.getSelectedItem().toString().equals("schnell")) {
