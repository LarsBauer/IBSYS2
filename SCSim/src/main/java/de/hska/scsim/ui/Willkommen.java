...
public class Willkommen extends JPanel {
	...
	public Willkommen() {
			...
			this.setLayout(gbl_panel);
			{
				...
				txtrHerzlichWillkommenDas.setText(Messages.getString("Willkommen.1")); //$NON-NLS-1$
			...
			{
				JButton btnNewButton = new JButton(Messages.getString("Willkommen.2")); //$NON-NLS-1$
