...
public class SafetyStock extends JPanel {
    ...
    public SafetyStock() {
        ...
        {
            JLabel lblProdukt = new JLabel(Messages.getString("production.product1"));
        ...
        {
            JLabel lblProdukt_1 = new JLabel(Messages.getString("production.product2"));
        ...
        {
            JLabel lblPrdoukt = new JLabel(Messages.getString("production.product3"));
        ...
        {
            JLabel lblFrAlleProdukte = new JLabel(Messages.getString("production.allproducts"));
